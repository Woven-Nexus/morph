...
export class FragmentTable1 extends MimicElement {
	...
	protected headerBeingResized?: HTMLElement;
	protected min = 150;
	protected columnTypeToRatioMap = {
		numeric:      1,
		'text-short': 1.67,
		'text-long':  3.33,
	};
	...
	public override afterConnectedCallback() {
		type Type = keyof FragmentTable1['columnTypeToRatioMap'];

		// Let's populate that columns array and add listeners to the resize handles
		this.renderRoot.querySelectorAll('th').forEach((header) => {
			const type = header.dataset['type'] as Type;
			const max = this.columnTypeToRatioMap[type] + 'fr';
			this.columns.push({
				header,
	...
	protected initResize = (ev: EventOf<HTMLElement>) => {
		...
		this.headerBeingResized = ev.target.parentNode as HTMLElement;
	...
	protected onMouseMove = (e: MouseEvent) => requestAnimationFrame(() => {
		if (this.headerBeingResized) {
			...
			if (column)
				column.size = Math.max(this.min, width) + 'px'; // Enforce the minimum
	...
	protected override render() {
		...
		<style>
			table#table {
				grid-template-columns:${ this.columns.map(({ size }) => size).join(' ') };
			}
		</style>
		<table id="table">
			<thead>
				<tr>
					<th @mousedown=${ this.initResize } data-type="numeric">ID <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-short">First name <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-short">Last name <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-short">Email <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-long">Street <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-short">Country <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-long">University <span class="resize-handle"></span></th>
					<th @mousedown=${ this.initResize } data-type="text-short">IBAN <span class="resize-handle"></span></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td><span>7850 Old Shore Drive</span></td>
				...
				<tr>
					...
					<td>Sidney</td>
					<td>Sargison</td>
					<td>ssargisonw@businessinsider.com</td>
					<td>5 Raven Drive</td>
					<td>Italy</td>
				...
				<tr>
					...
					<td>Rodney</td>
					<td>Everington</td>
					<td>reverington10@people.com.cn</td>
				...
				<tr>
					...
					<td>Linnea</td>
					<td>Gillingwater</td>
					<td>lgillingwater14@tamu.edu</td>
				...
				<tr>
					...
					<td>Urbano</td>
					<td>Baudinelli</td>
					<td>ubaudinelli1d@scribd.com</td>
				...
				<tr>
					...
					<td>Leonelle</td>
					<td>Stolte</td>
					<td>lstolte1e@marketwatch.com</td>
				...
				<tr>
					...
					<td>Georgiana</td>
					<td>Yashanov</td>
					<td>gyashanov1f@theatlantic.com</td>
				...
				<tr>
					...
					<td>Carly</td>
					<td>Foottit</td>
					<td>cfoottit1g@deviantart.com</td>
				...
				<tr>
					...
					<td>Merilee</td>
					<td>Winsom</td>
					<td>mwinsom1j@nationalgeographic.com</td>
				...
				<tr>
					...
					<td>Fannie</td>
					<td>Tummasutti</td>
					<td>ftummasutti1k@dion.ne.jp</td>
				...
				<tr>
					...
					<td>Xaviera</td>
					<td>Gilder</td>
					<td>xgilder1r@bravesites.com</td>
				...
				<tr>
					...
					<td>Fransisco</td>
					<td>Phelit</td>
					<td>fphelit1v@networkadvertising.org</td>
				...
				<tr>
					...
					<td>Bili</td>
					<td>Devanny</td>
					<td>bdevanny20@deliciousdays.com</td>
				...
				<tr>
					...
					<td>Gonzales</td>
					<td>Beaty</td>
					<td>gbeaty21@istockphoto.com</td>
				...
				<tr>
					...
					<td>Guy</td>
					<td>Sporrij</td>
					<td>gsporrij22@economist.com</td>
				...
				<tr>
					...
					<td>Fletch</td>
					<td>Meneghelli</td>
					<td>fmeneghelli24@google.com.au</td>
				...
				<tr>
					...
					<td>Adel</td>
					<td>Lansberry</td>
					<td>alansberry25@tripadvisor.com</td>
				...
				<tr>
					...
					<td>Kennett</td>
					<td>Goldston</td>
					<td>kgoldston27@usatoday.com</td>
				...
				<tr>
					...
					<td>Avigdor</td>
					<td>Brede</td>
					<td>abrede2a@liveinternet.ru</td>
				...
				<tr>
					...
					<td>Trey</td>
					<td>Garlick</td>
					<td>tgarlick2f@stumbleupon.com</td>
				...
				<tr>
					...
					<td>Tess</td>
					<td>Giovanetti</td>
					<td>tgiovanetti2j@usatoday.com</td>
				...
				<tr>
					...
					<td>Trix</td>
					<td>Boddie</td>
					<td>tboddie2k@stumbleupon.com</td>
					<td>29010 Mosinee Plaza</td>
					<td>Greece</td>
					<td>International Hellenic University</td>
					<td>AZ51 HKZB FGIX DQSJ GM6A ISWS NUBU</td>
				</tr>
				<tr>
					<td>000094</td>
					<td>Kelsy</td>
					<td>Sidgwick</td>
					<td>ksidgwick2l@newyorker.com</td>
				...
				<tr>
					...
					<td>Crosby</td>
					<td>Marron</td>
					<td>cmarron2o@stumbleupon.com</td>
				...
				<tr>
					...
					<td>Betteanne</td>
					<td>Cornick</td>
					<td>bcornick2p@theatlantic.com</td>
