import { m as I } from "./editor.api-B2Cf7Ob7.js";
import { t as N } from "./user-worker-H1G5OZMt.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var M = Object.defineProperty, R = Object.getOwnPropertyDescriptor, K = Object.getOwnPropertyNames, E = Object.prototype.hasOwnProperty, T = (e, t, r, o) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of K(t))
      !E.call(e, i) && i !== r && M(e, i, { get: () => t[i], enumerable: !(o = R(t, i)) || o.enumerable });
  return e;
}, H = (e, t, r) => (T(e, t, "default"), r && T(r, t, "default")), a = {};
H(a, I);
var V = class {
  constructor(e, t) {
...
var U = class L extends _ {
  ...
  async provideSignatureHelp(t, r, o, i) {
    ...
    const c = await s.getSignatureHelpItems(l.toString(), u, {
      triggerReason: L._toSignatureHelpTriggerReason(i)
    });
    if (!c || t.isDisposed())
      return;
    const g = {
