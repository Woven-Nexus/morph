...
const zo = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let Mo = (t) => crypto.getRandomValues(new Uint8Array(t)), $o = (t, o, e) => {
 ...
 */
const N = globalThis, V = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Z = Symbol(), J = /* @__PURE__ */ new WeakMap();
let mo = class {
  constructor(o, e, i) {
...
}, X = V ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((o) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Lo, defineProperty: No, getOwnPropertyDescriptor: To, getOwnPropertyNames: qo, getOwnPropertySymbols: jo, getPrototypeOf: Wo } = Object, v = globalThis, K = v.trustedTypes, Po = K ? K.emptyScript : "", U = v.reactiveElementPolyfillSupport, C = (t, o) => t, T = { toAttribute(t, o) {
  switch (o) {
    case Boolean:
      t = t ? Po : null;
      break;
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[C("elementProperties")] = /* @__PURE__ */ new Map(), y[C("finalized")] = /* @__PURE__ */ new Map(), U == null || U({ ReactiveElement: y }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const E = globalThis, q = E.trustedTypes, eo = q ? q.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, po = "$lit$", u = `lit$${(Math.random() + "").slice(9)}$`, go = "?" + u, Fo = `<${go}>`, x = document, B = () => x.createComment(""), S = (t) => t === null || typeof t != "object" && typeof t != "function", ho = Array.isArray, Uo = (t) => ho(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", O = `[ 	
\f\r]`, M = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, to = /-->/g, io = />/g, f = RegExp(`>|${O}(?:([^\\s"'>=/]+)(${O}*=${O}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), no = /'/g, ro = /"/g, bo = /^(?:script|style|textarea|title)$/i, Oo = (t) => (o, ...e) => ({ _$litType$: t, strings: o, values: e }), ao = Oo(1), k = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), co = /* @__PURE__ */ new WeakMap(), w = x.createTreeWalker(x, 129);
function uo(t, o) {
...
const Ro = (t, o) => {
  ...
  for (let d = 0; d < e; d++) {
    ...
    for (; h < c.length && (a.lastIndex = h, p = a.exec(c), p !== null); )
      h = a.lastIndex, a === M ? p[1] === "!--" ? a = to : p[1] !== void 0 ? a = io : p[2] !== void 0 ? (bo.test(p[2]) && (n = RegExp("</" + p[2], "g")), a = f) : p[3] !== void 0 && (a = f) : a === f ? p[0] === ">" ? (a = n ?? M, s = -1) : p[1] === void 0 ? s = -2 : (s = a.lastIndex - p[2].length, m = p[1], a = p[3] === void 0 ? f : p[3] === '"' ? ro : no) : a === ro || a === no ? a = f : a === to || a === io ? a = M : (a = f, n = void 0);
    const b = a === f && t[d + 1].startsWith("/>") ? " " : "";
    r += a === M ? c + Fo : s >= 0 ? (i.push(m), c.slice(0, s) + po + c.slice(s) + u + b) : c + u + (s === -2 ? d : b);
  }
  return [uo(t, r + (t[e] || "<?>") + (o === 2 ? "</svg>" : "")), i];
};
class I {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const s of n.getAttributeNames())
            if (s.endsWith(po)) {
              const h = p[a++], b = n.getAttribute(s).split(u), L = /([.?@])?(.*)/.exec(h);
              c.push({ type: 1, index: r, name: L[2], strings: b, ctor: L[1] === "." ? Qo : L[1] === "?" ? Vo : L[1] === "@" ? Zo : W }), n.removeAttribute(s);
            } else
              s.startsWith(u) && (c.push({ type: 6, index: r }), n.removeAttribute(s));
        if (bo.test(n.tagName)) {
          const s = n.textContent.split(u), h = s.length - 1;
          if (h > 0) {
            n.textContent = q ? q.emptyScript : "";
            for (let b = 0; b < h; b++)
              n.append(s[b], B()), w.nextNode(), c.push({ type: 2, index: ++r });
            n.append(s[h], B());
          }
        }
        ...
        if (n.data === go)
          ...
          let s = -1;
          for (; (s = n.data.indexOf(u, s + 1)) !== -1; )
            c.push({ type: 7, index: r }), s += u.length - 1;
        }
      r++;
    }
  }
...
class H {
  ...
  $(o) {
    var r;
    const { values: e, _$litType$: i } = o, n = typeof i == "number" ? this._$AC(o) : (i.el === void 0 && (i.el = I.createElement(uo(i.h, i.h[0]), this.options)), i);
...
R == null || R(I, H), (E.litHtmlVersions ?? (E.litHtmlVersions = [])).push("3.1.2");
const Jo = (t, o, e) => {
...
const Q = /* @__PURE__ */ new WeakMap(), pe = xo(class extends se {
  render(t) {
    return l;
  }
  update(t, [o]) {
  ...
  rt(t) {
    if (typeof this.Y == "function") {
      ...
      let e = Q.get(o);
      e === void 0 && (e = /* @__PURE__ */ new WeakMap(), Q.set(o, e)), e.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), e.set(this.Y, t), t !== void 0 && this.Y.call(this.ht, t);
    } else
      this.Y.value = t;
  }
  get lt() {
    var t, o;
    return typeof this.Y == "function" ? (t = Q.get(this.ht ?? globalThis)) == null ? void 0 : t.get(this.Y) : (o = this.Y) == null ? void 0 : o.value;
  }
  disconnected() {
...
var be = Object.defineProperty, ue = Object.getOwnPropertyDescriptor, z = (t, o, e, i) => {
  for (var n = i > 1 ? void 0 : i ? ue(o, e) : o, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (n = (i ? a(o, e, n) : a(n)) || n);
  return i && n && be(o, e, n), n;
};
let g = class extends ee {
  constructor() {
    super(...arguments), this.visible = !1, this.editorReady = (() => {
      const [t, o] = _o(), e = t;
      return e.resolve = o, e;
    })(), this.disposables = [], this.monacoRef = le(), this.resizeObs = new ResizeObserver(([t]) => {
      var e;
  ...
  disconnectedCallback() {
    var t;
    super.disconnectedCallback(), this.disposables.forEach((o) => o.dispose()), (t = this._editor) == null || t.dispose(), this.resizeObs.unobserve(this);
  }
  async afterConnected() {
    this.resizeObs.observe(this), await g.modifyLangConfig, F.defineTheme("Plastic", {
      ...
      this._editor.onDidChangeModel(() => {
        var t;
        this.visible = !!((t = this._editor) != null && t.getModel());
      })
    ), await Bo(100), this.editorReady.resolve(), Do(this, "editor-ready", { bubbles: !1 }), this.code !== void 0 && this.createModel(this.code, this.language ?? "typescript");
  }
  async createModel(t, o) {
    var i, n, r;
    await this.editorReady;
    const e = this.monaco.createModel(t, o);
    this.disposables.push(e), (i = this.editor) == null || i.setModel(e), (n = this.editor) == null || n.restoreViewState(null), (r = this.editor) == null || r.focus();
  }
  render() {
    return ao`
		<div
