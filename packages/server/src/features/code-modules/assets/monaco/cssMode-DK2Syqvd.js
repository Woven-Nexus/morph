import { m as je } from "./editor.api-B2Cf7Ob7.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var Ne = Object.defineProperty, We = Object.getOwnPropertyDescriptor, Oe = Object.getOwnPropertyNames, Ue = Object.prototype.hasOwnProperty, J = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of Oe(n))
      !Ue.call(e, t) && t !== i && Ne(e, t, { get: () => n[t], enumerable: !(r = We(n, t)) || r.enumerable });
  return e;
}, Ve = (e, n, i) => (J(e, n, "default"), i && J(i, n, "default")), c = {};
Ve(c, je);
var He = 2 * 60 * 1e3, ze = class {
  constructor(e) {
  ...
  _checkIfIdle() {
    if (!this._worker)
      return;
    Date.now() - this._lastUsedTime > He && this._stopWorker();
  }
  _getClient() {
...
(function(e) {
  ...
  function i(r) {
    var t = r;
    return t && s.string(t.title) && (t.diagnostics === void 0 || s.typedArray(t.diagnostics, O.is)) && (t.kind === void 0 || s.string(t.kind)) && (t.edit !== void 0 || t.command !== void 0) && (t.command === void 0 || D.is(t.command)) && (t.isPreferred === void 0 || s.boolean(t.isPreferred)) && (t.edit === void 0 || $.is(t.edit));
  }
  e.is = i;
})(be || (be = {}));
var xe;
...
(function(e) {
  ...
  e.is = i;
  function r(a, o) {
    for (var u = a.getText(), g = t(o, function(A, j) {
...
var it = class {
  ...
  provideRenameEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doRename(t.toString(), C(n), i)).then((a) => ot(a));
  }
};
function ot(e) {
  if (!e || !e.changes)
...
function Se(e) {
  return {
    ...
    tags: e.tags ?? [],
    children: (e.children ?? []).map((n) => Se(n))
  };
}
function Te(e) {
...
var pt = class {
  ...
  provideDocumentFormattingEdits(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.format(r.toString(), null, Fe(n)).then((a) => {
      if (!(!a || a.length === 0))
        return a.map(L);
    }));
  }
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), De(n), Fe(i)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(L);
    }));
  }
...
function mt(e) {
  ...
  function a() {
    ...
    Le(i), u.completionItems && i.push(
      c.languages.registerCompletionItemProvider(
        o,
        new Qe(t, ["/", "-", ":"])
      )
    ), u.hovers && i.push(
      c.languages.registerHoverProvider(o, new Ze(t))
      ...
      c.languages.registerDefinitionProvider(
        o,
        new nt(t)
      )
    ), u.references && i.push(
      c.languages.registerReferenceProvider(
        o,
        new it(t)
      )
      ...
      c.languages.registerRenameProvider(o, new at(t))
    ), u.colors && i.push(
      c.languages.registerColorProvider(
        o,
        new ft(t)
      )
