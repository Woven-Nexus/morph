import { m as qe } from "./editor.api-B2Cf7Ob7.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var Qe = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, Je = Object.getOwnPropertyNames, Ye = Object.prototype.hasOwnProperty, J = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of Je(n))
      !Ye.call(e, t) && t !== i && Qe(e, t, { get: () => n[t], enumerable: !(r = Ge(n, t)) || r.enumerable });
  return e;
}, Ze = (e, n, i) => (J(e, n, "default"), i && J(i, n, "default")), c = {};
Ze(c, qe);
var Ke = 2 * 60 * 1e3, De = class {
  constructor(e) {
...
function Ne(e) {
  return {
    ...
    tags: e.tags ?? [],
    children: (e.children ?? []).map((n) => Ne(n))
  };
}
function We(e) {
...
var He = class {
  ...
  provideDocumentFormattingEdits(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.format(r.toString(), null, Ve(n)).then((a) => {
      if (!(!a || a.length === 0))
        return a.map(L);
    }));
  }
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), Me(n), Ve(i)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(L);
    }));
  }
...
var mt = class {
  ...
  provideColorPresentations(e, n, i) {
    ...
    return this._worker(r).then(
      (t) => t.getColorPresentations(r.toString(), n.color, Me(n.range))
    ).then((t) => {
      if (t)
        return t.map((a) => {
          let o = {
...
function _t(e) {
  ...
  let r = e.languageId;
  c.languages.registerCompletionItemProvider(r, new Be(i)), c.languages.registerHoverProvider(r, new Se(i)), c.languages.registerDocumentHighlightProvider(
    r,
    new Fe(i)
  ), c.languages.registerLinkProvider(r, new He(i)), c.languages.registerFoldingRangeProvider(
    r,
    new ze(i)
    ...
    r,
    new Xe(i)
  ), c.languages.registerRenameProvider(r, new Le(i)), r === "html" && (c.languages.registerDocumentFormattingEditProvider(
    r,
    new Oe(i)
...
function wt(e) {
  ...
  function a() {
    ...
    $e(i), u.completionItems && i.push(
      c.languages.registerCompletionItemProvider(o, new Be(t))
    ), u.hovers && i.push(
      c.languages.registerHoverProvider(o, new Se(t))
      ...
      c.languages.registerLinkProvider(o, new He(t))
      ...
      c.languages.registerRenameProvider(o, new Le(t))
